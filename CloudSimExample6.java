...
public class CloudSimExample6 {
	...
	private static List<Vm> createVM(int userId, int vms) {
		...
		for(int i=0;i<vms;i++){
			vm[i] = new Vm(i, userId, mips+(2*i*10), pesNumber, ram, bw, size, vmm, new CloudletSchedulerSpaceShared());
	...
	private static void printCloudletList(List<Cloudlet> list,List<Vm> list1) {
		...
		String indent = "    ";
		Log.printLine();
		Log.printLine("========== OUTPUT FOR SHORTEST JOB FIRST SCHEDULING==========");
		...
		System.out.println("GA with SJFS ends....");	
